...
public class MaxMinFinder {
    ...
    public static void main(String args[]) {
        ...
        try {
            in = new Scanner(MaxMinFinder.class.getClassLoader().getResource("adult.data").getFile());
            ...
            logValues(max_1st, min_1st, max_3, min_3, max_5, min_5, max_11, min_11, max_12, min_12, max_13, min_13);
        } catch (NumberFormatException e) {
            e.printStackTrace();
        }
    }

    private static void logValues(int max_1st, int min_1st, int max_3, int min_3, int max_5, int min_5, int max_11, int min_11, int max_12, int min_12, int max_13, int min_13) {
