...
public class MyMaxMin {
	...
	public static class MaxTemperatureMapper extends Mapper<LongWritable, Text, Text, Text> {
		...
		/**
		 * @method map This method takes the input as a text data type. Now leaving the
		 *         first five tokens, it takes 6th token is taken as temp_max and 7th
		 *         token is taken as temp_min. Now temp_max > 30 and temp_min < 15 are
	...
	public static class MaxTemperatureReducer extends Reducer<Text, Text, Text, Text> {
		...
		/**
		 * @method reduce This method takes the input as key and list of values pair
		 *         from the mapper, it does aggregation based on keys and produces the
		 *         final context.
		 */
